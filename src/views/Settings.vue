	...
	<div class="2xl:container 2xl:mx-auto">
		<div class="flex items-center h-16 px-4 bg-white shadow-sm">
			<div class="flex items-center space-x-2">
				<router-link class="flex items-center w-8 h-8 justify-center bg-transparent hover:bg-gray-200 rounded text-sm text-gray-500 leading-4 font-medium transition duration-100" to="/">
